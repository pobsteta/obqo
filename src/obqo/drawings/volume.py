...
from obqo.model.systeme import BriquePosee, Calepinage, MurCalepine, Rang
from obqo.rules.geometrie_brique import MODULE, PiecePlacee, cellules_vides, pieces_de
from obqo.units import EPAISSEUR_MUR, HAUTEUR_RANG
