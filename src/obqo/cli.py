...
from obqo.drawings.planches import dossier as planches_du_dossier
from obqo.engine.calepinage import calepiner as calepiner_le_plan
from obqo.engine.validation import Gravite, Rapport
from obqo.gabarit import GABARIT
...
def gabarit(
    ...
    console.print(
        ...
        f"Modifier les cotes, puis : [bold]obqo valider {sortie}[/bold]\n"
